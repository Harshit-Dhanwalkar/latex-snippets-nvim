...
return {
	...
	-- LaTex: Set Notations
	s(
		{ trig = "set", wordTrig = false, snippetType = "autosnippet" },
		fmta("{ <> }", { i(1) }),
		{ condition = in_mathzone }
	),
	s(
		{ trig = "setb", wordTrig = false, snippetType = "autosnippet" },
		fmta("{ <> \\mid <> }", { i(1), i(2) }),
		{ condition = in_mathzone }
	),

	-- LaTex Math operators
	s({ trig = "grad", snippetType = "autosnippet" }, t(" \\nabla "), { condition = in_mathzone }),
	s({ trig = "div", snippetType = "autosnippet" }, t(" \\nabla \\cdot "), { condition = in_mathzone }),
	s({ trig = "curl", snippetType = "autosnippet" }, t(" \\nabla \\times "), { condition = in_mathzone }),
	s({ trig = "lap", snippetType = "autosnippet" }, t(" \\Delta "), { condition = in_mathzone }),
	s({ trig = "inf", snippetType = "autosnippet" }, t(" \\infty "), { condition = in_mathzone }),

	-- LaTex: Expectations and Probability
	s(
	...
	s(
		{ trig = "Var", wordTrig = false, snippetType = "autosnippet" },
		fmta("\\mathrm{Var}(<>)", { i(1) }),
		{ condition = in_mathzone }
	),
}
